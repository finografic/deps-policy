import type { AuditEntry, OsvVulnerability } from 'types/audit.types.js';
import type { DepEntry } from 'types/dep-metadata.types.js';

import { BATCH_SIZE, OSV_BATCH_URL } from './audit.constants.js';
...
async function queryOsvBatch(queries: OsvQuery[]): Promise<OsvVulnerability[][]> {
